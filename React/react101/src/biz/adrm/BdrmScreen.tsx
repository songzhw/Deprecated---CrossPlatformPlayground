...
export const BdrmsScreen: React.FC = () => {
  ...
  return (
    <div>
      ...
      <p/>
      <img src={`data:image/jpeg;base64,${reactLogoImage}`}/>
    </div>
  );
};
