...
function (_PureComponent) {
  ...
  function TocItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setLocation", function () {
...
function (_PureComponent2) {
  ...
  function ReactReader(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "toggleToc", function () {
      _this2.setState({
        expanedToc: !_this2.state.expanedToc
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "next", function () {
      var node = _this2.readerRef.current;
      node.nextPage();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "prev", function () {
      var node = _this2.readerRef.current;
      node.prevPage();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "onTocChange", function (toc) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "setLocation", function (loc) {
  ...
  _createClass(ReactReader, [{
    ...
    value: function renderToc() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        return _react.default.createElement(TocItem, _extends({
          key: item.href
        }, item, {
    ...
    value: function render() {
      ...
      }, title), _react.default.createElement(_reactSwipeable.default, {
