...
export const FetchBlobDemo = () => {
  ...
  // TODO FAILED to display an image. Still investigating
  ...
  function downloadAndReadEpub() {
    ...
    RNFetchBlob
      ...
      .then(path => {
        ...
        unzip(path, dist)
          .then(zipPath => console.log("szw unzip = " + zipPath))
          .catch(error => console.log(`szw error6 = `, error))
        ;
      })
      .catch((error: any) => console.log(`szw error5 = `, error));
  ...
  return (
    <View>
      ...
      <Button title={"download + read EPUB"} onPress={downloadAndReadEpub}/>
    </View>
  );
};
