...
class FelaDemo4 extends PureComponent {
  state = {
    id: 100,
    num: 18
  }
  ...
  render() {
    ...
    console.log(`szw render4 = ${JSON.stringify(this.props)}`)
...
const mapThemeToProps = (top) => {
  console.log(`map4 theme4 = ${JSON.stringify(top)}`)
  return {...top.theme}
}
...
export default connectRedux(mapStateToProps)(
  connectFela(mapThemeToProps)(FelaDemo4)
)