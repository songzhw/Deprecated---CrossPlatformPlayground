...
export const SvgCanvas14_Text = (props: IProps) => {
  ...
  return (
    <Svg>
      ...
      <Text fill="black" fontSize={22} x={20} y={610} textDecoration="blink" >Have you done writing?</Text>
      <Text fill="black" fontSize={22} x={20} y={640} textDecoration="overline" >Have you done writing?</Text>
      <Text fill="black" fontSize={22} x={20} y={670} textDecoration="underline" >Have you done writing?</Text>
      <Text fill="black" fontSize={22} x={20} y={700} textDecoration="line-through" >Have you done writing?</Text>
    </Svg>
  );
};
